package com.truedreamz.svglinedrawing.LineDrawing;
...
import com.truedreamz.svglinedrawing.R;
...
public class SVGPathView extends View implements SvgUtils.AnimationStepListener {
    /**
     * Logging tag.
     */
    ...
    private void getFromAttributes(Context context, AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SVGPathView);
        try {
            if (a != null) {
                paint.setColor(a.getColor(R.styleable.SVGPathView_pathColor, 0xff00ff00));
                paint.setStrokeWidth(a.getDimensionPixelSize(R.styleable.SVGPathView_pathWidth, 8));
                svgResourceId = a.getResourceId(R.styleable.SVGPathView_svg, 0);
                naturalColors = a.getBoolean(R.styleable.SVGPathView_naturalColors, false);
                fill = a.getBoolean(R.styleable.SVGPathView_fill,false);
                fillColor = a.getColor(R.styleable.SVGPathView_fillColor, Color.argb(0,0,0,0));
            }
        } finally {
            if (a != null) {
                a.recycle();
    ...
    public static class AnimatorBuilder {
         ...
         */
        public AnimatorBuilder(final SVGPathView pathView) {
